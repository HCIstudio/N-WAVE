          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    onSettingsChange({
                      outputDirectory: e.target.value.replace(/\\/g, "/"),
                    })
                  }
                  placeholder="results"
                        ...
                        try {
                          ...
                          const selectedPath =
                            directoryHandle.name === "."
                              ...
                              : directoryHandle.name;
                          onSettingsChange({
                            outputDirectory: selectedPath.replace(/\\/g, "/"),
                          });
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({ outputNaming: e.target.value })
                }
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onSettingsChange({ maxMemory: e.target.value })
                }
